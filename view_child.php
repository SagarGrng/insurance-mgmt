...
$query = "select * from policies where pol_name='child'";
...
<form role="form" action="child_ins.php" method="post" name="polup" > 
        ...
        <div class="form-group">
			<input type="submit" name="childup" value="Submit" class="btn btn-primary" />
		</div>
  </form>
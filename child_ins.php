...
if (isset($_POST['childup'])) {
	...
	if (!$error) {
		...
		if(!($how == '')){
            ...
            echo "yipeee";
            echo "<script>alert('Successfully Inserted!!'); location.href='view_child.php';</script>";
		} 
		else {
            //$errormsg = "Error in inserting...Please try again later!";
            echo "<script>alert('Error in inserting...Please try again later!') location.href='view_child.php';</script>";
		}
    }
    else{
        echo $error;?>
